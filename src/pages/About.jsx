    ...
    <div className="bg-neutral-900 text-white min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-4xl w-full mx-auto">
          <h1 className="text-3xl font-bold text-center mb-8">About InsiderX</h1>
          
          <div className="bg-neutral-800/50 backdrop-blur-md rounded-xl p-8 border border-neutral-700 mb-12">
            <h2 className="text-2xl font-bold mb-4 text-blue-400">What is InsiderX?</h2>
            <p className="text-gray-300 leading-relaxed">
              InsiderX is a real-time market intelligence platform that tracks insider trading activities 
